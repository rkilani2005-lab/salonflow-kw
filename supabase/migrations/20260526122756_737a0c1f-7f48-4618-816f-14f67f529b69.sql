...
begin
  ...
  select p_tenant_id, code, name, name_ar, account_type, account_subtype, false, true
    from new_accounts
  ...
  on conflict (tenant_id, mapping_type, source_key)
    do update set credit_account_id = excluded.credit_account_id, label = excluded.label, updated_at = now();
  ...
  on conflict (tenant_id, mapping_type, source_key)
    do update set credit_account_id = excluded.credit_account_id, debit_account_id = excluded.debit_account_id, label = excluded.label, updated_at = now();
  ...
  on conflict (tenant_id, mapping_type, source_key)
    do update set debit_account_id = excluded.debit_account_id, credit_account_id = excluded.credit_account_id, label = excluded.label, updated_at = now();
  ...
  on conflict (tenant_id, mapping_type, source_key)
    do update set debit_account_id = excluded.debit_account_id, label = excluded.label, updated_at = now();
